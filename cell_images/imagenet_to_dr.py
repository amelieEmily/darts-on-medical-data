...
parser.add_argument('--valid_files', type=str, default=dr_detection_data_path + '/test_public_df.csv',
                    help='path to the csv file that contain validation images')
parser.add_argument('--train_files', type=str, default=dr_detection_data_path + '/train_balanced_subset_df.csv',
...
def main():
  ...
  train_data = ImageLabelDataset(shuffle=True,transform=train_transform, train=True)
  valid_data = ImageLabelDataset(shuffle=True,transform=valid_transform, train=False)
